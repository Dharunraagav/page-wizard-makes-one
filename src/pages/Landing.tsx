          ...
          >
            <div className="flex items-center justify-center">
              {letters.map((letter, index) => (
                <motion.span
                  key={index}
                  className={`text-5xl font-bold inline-block ${letter === "-" ? "mx-1" : ""} ${index === 0 ? "text-e-green" : ""}`}
